...
class DrawView : SVGImageView {
    ...
    private fun init(context: Context, canvas: Canvas) {
        ...
        rect.transform(Matrix().apply { setValues(floatArrayOf(1.93f, 0f, 0f, 0f, 1.93f, 0f, 0f, 0f, 1f)) }) // scale the parsed path by the ratio the viewBox is scaled up for the native view
