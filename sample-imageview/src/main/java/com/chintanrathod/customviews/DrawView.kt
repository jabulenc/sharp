...
class DrawView : SVGImageView {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //canvas.scale(1.93f, 1.93f) // this made it work, kinda
        //canvas.translate()
...
//                    svg2
                    ...
                    if (startMovePoint != null) {
                        ...
                        ((svg2.base.rootElement.children[0] as SVGBase.Group)).transform = ((svg2.base.rootElement.children[0] as SVGBase.Group)).transform.times(Matrix().apply { setValues(floatArrayOf(1f, 0f, -xOffset.toFloat() * xScale, 0f, 1f, -yOffset.toFloat() * yScale, 0f, 0f, 1f)) })
                    (svg2.base.rootElement.children[0] as SVGBase.Group).transform
                    //setSVG(svg2)
