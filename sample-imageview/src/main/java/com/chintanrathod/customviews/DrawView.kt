...
//        point3!!.y = bottom - (paddingRight * 2)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (paint == null) {
            ...
            left = svg2.documentViewBox.left.roundToInt()
            right = svg2.documentViewBox.right.roundToInt()
            top = svg2.documentViewBox.top.roundToInt()
            bottom = svg2.documentViewBox.bottom.roundToInt()
            layoutParams = layoutParams.apply {
                width = svg2.documentViewBox.right.roundToInt() - svg2.documentViewBox.left.roundToInt()
                height = svg2.documentViewBox.bottom.roundToInt() - svg2.documentViewBox.top.roundToInt()
            }
            init(context)
            requestLayout()
            invalidate()
