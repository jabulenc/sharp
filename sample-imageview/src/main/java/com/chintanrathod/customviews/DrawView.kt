...
class DrawView : SVGImageView {
    ...
    private fun init(context: Context, canvas: Canvas) {
        ...
        val output = saxParser.parse( stringSvg.byteInputStream(), handler)
        ...
        ((svg2.base.rootElement.children[0] as SVGBase.Group).children[0] as SVGBase.Path).d
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        ((svg2.base.rootElement.children[0] as SVGBase.Group).children[0] as SVGBase.Path).boundingBox
        val newBbox = rect
